violin.plot <- function(datas,...,range=1.5,h=NULL,ylim=NULL,names=NULL, horizontal=FALSE, 
  col="grey80", border="black", lty=1, lwd=1, rectCol="black", colMed="white", pchMed=19, at, add=FALSE, wex=1, 
  drawRect=TRUE)
{


    if (FALSE) {
        source(file.path(plotFuncs.path, "violin.plot.R"))
    }
